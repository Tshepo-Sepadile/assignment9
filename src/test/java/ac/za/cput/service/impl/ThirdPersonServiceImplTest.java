...
public class ThirdPersonServiceImplTest {
    ...
    public void a_create() {
        ...
        ThirdPerson person = ThirdPersonFactory.getPerson("Tshepo","Sepadile","00001");
    ...
    public void c_update() {
        ...
        ThirdPerson person = ThirdPersonFactory.getPerson("Tshepo", "Sepadile", personId);
    ...
    public void b_read() {
        ...
        ThirdPerson p = ThirdPersonFactory.getPerson("Tshepo", "Sepadile", "00001");
        p = service.create(p);
    ...
    public void d_getAll() {
        ...
        List<ThirdPerson> persons = this.service.getAll();
